...
let centerSettingPhoto = 0;
let leftSettingPhoto = 0;
let topSettingPhoto = 0;
let rightSettingPhoto = 0;
...
function changeImageSetting(val) {
  if (val === "previous") {
    ...
    topSettingPhoto--;
    rightSettingPhoto--;
    centerPhoto.src = arrayOfCenterPhotoSetting[centerSettingPhoto];
    console.log(arrayOfRightPhotoSetting.length);
    leftPhoto.src = arrayOfLeftPhotoSetting[leftSettingPhoto];
    topPhoto.src = arrayOfTopPhotoSetting[topSettingPhoto];
    rightPhoto.src = arrayOfRightPhotoSetting[rightSettingPhoto];
  } else {
    centerSettingPhoto++;
    leftSettingPhoto++;
    topSettingPhoto++;
  ...
  settingTitle.textContent = arrayOfTitles[centerSettingPhoto];

  if (centerSettingPhoto === arrayOfCenterPhotoSetting.length - 1) {
    btnNextSetting.disabled = true;
  } else {
    btnNextSetting.disabled = false;
  }

  if (rightSettingPhoto === arrayOfRightPhotoSetting.length - 4) {
    console.log(arrayOfRightPhotoSetting);
    btnPrevSetting.disabled = true;
  } else {
...
console.log(serviceListMobile[0].number);
